<template>
          ...
          <div class="col-sm-8 col-12">       
            <div class="card">
              <div class="car-header text-center">
                <h3>Actualizar Datos Secuenciales</h3>
              </div>
              <div class="card-body">                
                  <div class="row" slot="body">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" maxlength="3" v-model="model.codigo_establecimiento" name="" class="form-control" id="">
                        </div>
                        <div class="form-group">
                            <label for="">Punto de Emisión</label>
                            <input type="text" maxlength="3" v-model="model.punto_emision" name="" class="form-control" id="">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" maxlength="9" v-model="model.sec_ini_com_ret" name="" class="form-control" id="" placeholder="000000001"  v-bind:readonly="isFieldDisabled">
                        </div>
                        <div class="form-group">
                            <label for="">Sec. Siguiente Comprobante de Retención</label>
                            <input type="text" maxlength="9" v-model="model.sec_sig_com_ret" name="" class="form-control" id="" placeholder="000000001" v-bind:readonly="isFieldDisabled">
                        </div>
                        <div class="form-group">
          ...
          async Save(){
            if(!validacionSoloNumeros(this.model.codigo_establecimiento) || !validacionSoloNumeros(this.model.punto_emision ||
              ...
              this.model.sec_ini_liq_comp.trim().length!=9 || this.model.sec_sig_liq_comp.trim().length!=9)
              {
                ...
                this.load = true;                
            try {
              const res = await this.$api.$put(this.apiUrl+'/'+this.$route.params.id, this.model);
              this.$swal.fire({
              title: "Dato Guardado",
    ...
    mounted(){
      this.$nextTick(async()=>{
        try {        
            await Promise.all([this.GET_DATA('secuencialId/'+this.$route.params.id)]).then((v)=>{
                this.model=v[0];  
                this.isFieldDisabled = this.model.datos_emisores.agente_retencion == 1 ? false : true;                
            })
        } catch (e) {
          console.log(e);
        }finally{
